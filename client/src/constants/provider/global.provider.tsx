...
export const GlobalProvider: FC<{ children: ReactNode, initialIsMobile?: boolean }> = ({ children, initialIsMobile }) => {
    ...
    const [isMobile, setIsMobile] = useState(!!initialIsMobile); // mobile by default to avoid squeezing
